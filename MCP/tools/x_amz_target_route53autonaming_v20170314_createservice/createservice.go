...
func CreateserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateServiceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53AutoNaming_v20170314.CreateService", cfg.BaseURL)
		...
		var result models.CreateServiceResponse
...
func CreateCreateserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Route53AutoNaming_v20170314.CreateService",
		...
		mcp.WithString("DnsConfig", mcp.Description("")),
		mcp.WithString("HealthCheckCustomConfig", mcp.Description("")),
		mcp.WithString("Type", mcp.Description("")),
		mcp.WithString("CreatorRequestId", mcp.Description("")),
		mcp.WithString("HealthCheckConfig", mcp.Description("")),
		mcp.WithString("Name", mcp.Required(), mcp.Description("")),
		mcp.WithString("NamespaceId", mcp.Description("")),
		mcp.WithString("Tags", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreateserviceHandler(cfg),
	}
}
