...
func CreateprivatednsnamespaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreatePrivateDnsNamespaceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53AutoNaming_v20170314.CreatePrivateDnsNamespace", cfg.BaseURL)
		...
		var result models.CreatePrivateDnsNamespaceResponse
...
func CreateCreateprivatednsnamespaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Route53AutoNaming_v20170314.CreatePrivateDnsNamespace",
		...
		mcp.WithString("Vpc", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateprivatednsnamespaceHandler(cfg),
	}
}
