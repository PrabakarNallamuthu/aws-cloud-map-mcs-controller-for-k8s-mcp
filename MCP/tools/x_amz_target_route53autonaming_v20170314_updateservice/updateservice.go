...
func UpdateserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateServiceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53AutoNaming_v20170314.UpdateService", cfg.BaseURL)
		...
		var result models.UpdateServiceResponse
