...
func CreatepublicdnsnamespaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreatePublicDnsNamespaceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53AutoNaming_v20170314.CreatePublicDnsNamespace", cfg.BaseURL)
		...
		var result models.CreatePublicDnsNamespaceResponse
...
func CreateCreatepublicdnsnamespaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Route53AutoNaming_v20170314.CreatePublicDnsNamespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatepublicdnsnamespaceHandler(cfg),
	}
}
