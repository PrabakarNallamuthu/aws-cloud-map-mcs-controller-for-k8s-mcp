...
func CreatehttpnamespaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateHttpNamespaceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53AutoNaming_v20170314.CreateHttpNamespace", cfg.BaseURL)
		...
		var result models.CreateHttpNamespaceResponse
...
func CreateCreatehttpnamespaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Route53AutoNaming_v20170314.CreateHttpNamespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatehttpnamespaceHandler(cfg),
	}
}
